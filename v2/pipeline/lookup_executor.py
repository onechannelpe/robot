...
from v2.domain.types import RUC, LookupResult, Status
from v2.obs.events import LOOKUP_FAILED, LOOKUP_OK
from v2.obs.logging import kv
from v2.providers.osiptel_flow import count_carrier_lines
